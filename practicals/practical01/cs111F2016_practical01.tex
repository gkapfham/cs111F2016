...
\begin{document}
\MYTITLE{Practical 1\\Assigned: Friday, September 2, 2016\\Due: Friday, September 9, 2016 at the start of class\\``Checkmark'' grade}

% \begin{document}
% \MYTITLE{Laboratory Assignment One: Version Control with Git and Bitbucket}
% \MYHEADERS{Laboratory Assignment One}{Due: January 28, 2016}
...
\begin{enumerate}
  ...
  \item Using your terminal window, you should browse the files that are in this Git repository.  In particular, please
    look in the {\tt cs111f2016-share/practicals/practical01/} directory and use {\tt gvim} to study the Java program that
