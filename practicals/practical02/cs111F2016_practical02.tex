\input{111pre}
\begin{document}
\MYTITLE{Practical 2\\September 9, 2016\\Due in Bitbucket by midnight of the day of your practical \\ ``Checkmark'' grade}
...
explains how to print some of the special characters, a topic that is also discussed at the end of this assignment; in
particular, please examine the examples of escape sequences in Figure 2.1. Please see the course instructor if you have
questions about using escape characters.
...
please show a teaching assistant or the course instructor the problem that you are encountering. Remember, when you are
programming it is important for you to work incrementally by typing a few lines of code and then trying to compile your
program and resolve any errors surfaced by the compiler.
