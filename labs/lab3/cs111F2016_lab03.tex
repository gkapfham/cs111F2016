\input{111pre}
\begin{document}
\MYTITLE{Lab 3 \\Assigned: September 14, 2016\\Due: Wednesday, September 21, 2016 by 2:30 pm}
...
In your {\tt cs111F2016-<your user name>} directory type the command ``{\tt mkdir lab3}'' to create a new directory for
